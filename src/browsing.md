...
| Name              | Action                                                                                                                                                                                                                                                                                                                                                     |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Add Notes         | Open the [Add](editing.md#Додавання-карток-та-нотаток) dialog.                                                                                                                                                                                                                                                                                                  |
| Create Copy       | Open a [duplicate](browsing.md#Пошук-дублікатів) of the current note in the [editor](editing.md#Додавання-карток-та-нотаток), which can be slightly modified to easily obtain variations of your cards. By default, the duplicate card will be created in the same deck as the original.                                                                      |
...
| Manage Note Types  | Open the [Notetypes](editing.md#Додавання-типу-нотатки) dialog.                                                                                                                                                                                                                                                                                                |
...
| Toggle Suspend | [Suspend](studying.md#Редагувати-та-Більше) or unsuspend all selected cards, depending on whether the current card is suspended or not.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
