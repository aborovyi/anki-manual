...
запитання, а з іншої - відповідь. Картка у Anki виглядає не так, як справжня
картка, і, типово, коли Ви бачите відповідь, то одночасно бачите і запитання.
...
- **Навчальна:** Картки, які Ви бачили вперше нещодавно і їх все ще
треба запам'ятати.
...
- **Перенавчальна:** Перенавчальною є картка, на якій Ви помилилися у режимі
пригадування, а тому вона повернулась у режим навчання для повторного вивчення.
...
їй план, який міститиме перелік полів лицьової та зворотної сторони для
...
Кожний тип картки має два 'шаблони', один длязапитання і один для відповіді.
...
- **Закритий текст**
  ...
  місяць у 1969 році"). Цей тип детальніше описано у параграфі
  [Закривання тексту](editing.md#Закривання-тексту).

- **Закрите зображення**
  Цей тип схожий на закритий текст, однак працює з зображенням, а не текстом,
  що обобливо корисно, коли навчальний матеріал дуже сильно залежить від
  зображень, як от анатомія, географія тощо. Цей тип детальніше описано у 
  параграфі [Закривання зображень](editing.md#Закривання-зображень).
