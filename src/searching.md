...
`is:buried`\
cards that have been buried, either [automatically](studying.md#Сестринські-картки-та-відкладання) or
manually.

Cards that have [lapsed](deck-options.md#Невдачі) fall into several of the previous categories, so it may
