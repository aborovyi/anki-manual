...
- **Інформація про попередню картку**: Показує
 ...
 - [**Позначити нотатку**](editing.md#Мітка-marked): Додає до поточної
  картки мітку "marked", щоб її легко знайти у навігаторі. Ця поведінка
...
Оскільки картки під час навчання є дещо критичними щодо часу, вони вибираються
...
ті колоди, у яких будуть всі шукані терміни. Наприклад, обидві комбінації
"ja 1" та "on1 ja" відповідають колоді "Japanese::Lesson1".
